...
def Page_about_data():
    ...
    image = load_image(r"https://github.com/ahmedyasser7/accidents_app/blob/183a19a669f62717803ec89a0fe3a95788372681/analysis_images/correlation.png")
    st.image(image)
    image = load_image(r"https://github.com/ahmedyasser7/accidents_app/blob/183a19a669f62717803ec89a0fe3a95788372681/analysis_images/HeatmapofAccidentSeveritybyRoadSurface.png")
    st.image(image)
    image = load_image(r"https://github.com/ahmedyasser7/accidents_app/blob/183a19a669f62717803ec89a0fe3a95788372681/analysis_images/urban_vs_rural.png")
    st.image(image)
