...
def Page_about_data():
    ...
    image = load_image(r"https://github.com/ahmedyasser7/accidents_app/blob/main/analysis_images/correlation.png")
    st.image(image)
    image = load_image(r"https://github.com/ahmedyasser7/accidents_app/blob/main/analysis_images/HeatmapofAccidentSeveritybyRoadSurface.png")
    st.image(image)
    image = load_image(r"https://github.com/ahmedyasser7/accidents_app/blob/main/analysis_images/urban_vs_rural.png")
    st.image(image)
